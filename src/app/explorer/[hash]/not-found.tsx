  ...
  return (
    <div className="min-h-screen bg-[var(--bg-primary)] flex flex-col items-center justify-center font-sans text-white px-4">
      <div className="border border-[var(--border-dark)] bg-[#050505] p-12 max-w-lg w-full text-center">
        ...
        <h1 className="text-3xl font-bold uppercase tracking-tight mb-2">Hash Not Found</h1>
        <p className="text-[10px] font-mono text-[var(--text-muted)] uppercase tracking-widest mb-8">
          The requested cryptographic audit hash could not be verified on the ledger.
        </p>
        <Link href="/explorer" className="inline-block px-8 py-3 bg-[var(--rolex-gold)] text-black text-[10px] font-mono font-bold tracking-widest uppercase hover:bg-white transition-colors">
          RETURN TO EXPLORER
        </Link>
      </div>
    </div>
